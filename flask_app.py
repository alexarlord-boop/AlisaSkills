...
def handle_dialog(res, req):
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        res['response']['buttons'] = [{'title': 'Help', 'hide': True}]
        if begging_for_help(req):
            res['response'][
                'text'] = 'Это игра угадайка.\nНапишите, какой город вы видите на картинке. У вас 3 попытки.Удачи)'
        else:
...
def play_game(res, req):
    ...
    # увеличиваем номер попытки до следующего шага
    sessionStorage[user_id]['attempt'] += 1
